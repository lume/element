...
An example that shows how to write a custom element and then use it in a Svelte
...
to run the example in dev mode, which means that the example will automatically
refresh when you save any files.
...
to build the app into files that you can publish onto a web server for
production.
