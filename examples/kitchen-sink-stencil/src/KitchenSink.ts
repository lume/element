...
export const KitchenSink = element('kitchen-sink')(
	class extends Element {
		...
		// setting up Solid JSX for certain files alongside Stencil JSX.
		...
		// altogether), and to have the Stencil app import the elements.
		template = () => html`
			<div>
...
declare module '@stencil/core' {
	export namespace JSX {
		interface IntrinsicElements {
			'kitchen-sink': StencilElementAttributes<KitchenSink, KitchenSinkAttributes, {blah?: number}>
		}
	}
}
